...
nw_pcode3 <- hno %>% 
  ...
  # Putting this here, since it's best to make sure that it always runs, when in this document
...
# consider using the dates to indicate which activities were ongoing
